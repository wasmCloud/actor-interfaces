...
//! # waSCC Key-Value Store Actor Interface
//!
//! This crate provides waSCC actors with an interface to the key-value capability provider. Actors using this
//! interface must have the claim `wascc:key_value` in order to have permission to communicate with the store.
//!
